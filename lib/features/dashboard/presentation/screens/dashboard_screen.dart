...
import '../../../../core/config/notifications/notification_housekeeping.dart';
...
class DashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final String todayMonthDay = today.substring(5);
    ...
    ref.watch(notificationHousekeepingProvider);
    ...
    final String ownerName = ref.watch(settingsProvider).maybeWhen(
              data: (Map<String, String> map) => map['first_name'],
              orElse: () => null,
            ) ??
        'there';
              ...
              return inventoryAsync.when(
                ...
                data: (List<InventoryItem> inventory) {
                  final int completed = appts
                      .where(
                        (Appointment a) => a.status == 'completed',
                      )
                      .length;
                      ...
                      .fold<int>(
                        ...
                        (
                          ...
                          Appointment appointment,
                            ...
                            sum + appointment.amount,
                      );

                  final List<Customer> birthdays = customers
                      .where(
                        (Customer customer) =>
                            (customer.birthday ?? '').endsWith(todayMonthDay),
                      )
                      .toList();

                  final List<InventoryItem> lowStock = inventory
                      .where(
                        (InventoryItem item) => item.stock <= item.minStock,
                      )
                      .toList();
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius:
                        unreadCount > 9 ? BorderRadius.circular(10.r) : null,
                  ),
                  child: unreadCount > 9
                      ? Text(
    ...
    return AppCard(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          for (final Customer customer in birthdays)
            Padding(
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 2.h),
                Text(
                  appointment.services.replaceAll(',', ', '),
                  style: AppTypography.caption(
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (
        ...
        final ({String label, IconData icon}) action = _actions[index];
